...
: ${AMENT_CURRENT_PREFIX:="/home/ivan/Desktop/Unicamp/IvanUnicamp/Disciplinas/IM_420_Sistemas_Embarcados_de_Tempo_Real/Trabalho/microros_ws/install/micro_ros_setup"}
